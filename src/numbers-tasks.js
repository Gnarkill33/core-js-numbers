...
/**
 * Returns a circumference of circle given by radius. СДЕЛАТЬ
 *
 * @param {number} radius
 * @return {number}
 *
...
/**
 * Returns an average of two given numbers. СДЕЛАТЬ
 *
 * @param {number} value1
 * @param {number} value2
 * @return {number}
...
/**
 * Returns a root of linear equation a*x + b = 0 given by coefficients a and b. СДЕЛАТЬ
 *
 * @param {number} a
 * @param {number} b
 * @return {number}
...
/**
 * Returns a diagonal length of the rectangular parallelepiped given by its sides a,b,c. СДЕЛАТЬ
 *
 * @param {number} a
 * @param {number} b
 * @param {number} c
...
/**
 * Returns the number rounded to specified power of 10. СДЕЛАТЬ
 *
 * @param {number} num
 * @param {number} pow
 * @return {number}
